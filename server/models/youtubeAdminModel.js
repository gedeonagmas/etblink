...
const youtubeAdminSchema = new mongoose.Schema(
  {
    firstName: {
      type: String,
...
youtubeAdminSchema.pre("findOneAndUpdate", function (next) {
  this.options.runValidators = true;
  next();
});

youtubeAdminSchema.pre("save", function (next) {
  let percent = 20;
  const fields = [
    "firstName",
    "middleName",
...
const YoutubeAdmin = mongoose.model("youtube-admin", youtubeAdminSchema);
module.exports = { YoutubeAdmin };
