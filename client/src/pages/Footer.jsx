...
const Footer = () => {
  return (
    <div className="">
      ...
      <div
        style={{}}
        className="w-full px-main flex flex-col items-center justify-between h-auto mt-20"
      >
        ...
        <div className="w-full h-auto py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-9 place-items-center gap-x-2 gap-y-5">
