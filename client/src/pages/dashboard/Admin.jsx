...
const Admin = (props) => {
  ...
  const earnTable = {
    ...
    // options: {
    //   labels: ["Subscription", "Boost", "Fund"],
    //   colors: ["#FF0000", "#Ffa000", "#00aeff"],
    //   chart: {
    //     type: "donut",
    //   },
    //   legend: {
  ...
  return (
    <div className="w-full pb-10 md:pr-3 lg:pr-10 md:pl-3 flex flex-col xl:flex-row gap-5">
      {isFetching && (
      ...
      {/* {data && (
        <> */}
      {data && (
        <div className="flex flex-col lg:border-r pr-4 w-full xl:flex-[68%]">
          <Promotion />
                          ...
                          >
                            ...
                            <td class="px-1 w-20 text-center py-4">
                              ...
                              <a
                                ...
                                data-modal-target="editUserModal"
                                data-modal-show="editUserModal"
                                class="font-medium p-1 rounded-full ml-1 bg-main text-white hover:underline"
                              >
                                <svg
                                  class="w-4 h-4"
                                  aria-hidden="true"
      ...
      {data && (
        <div className="flex flex-col w-full pr-4 xl:flex-[32%]">
          <div className="flex gap-1 lg:flex-col xl:flex-row items-center justify-between p-2 bg-gray-100 dark:bg-gray-600 rounded-sm">
            ...
            <div className="flex p-2 w-full xl:w-[90px] relative h-full bg-white bg-dark">
              <div className=" rounded-lg gap-1 flex flex-col items-start justify-start">
                ...
                <p className="text-xs">Total {formatNumber(data?.visitor)} </p>
              </div>
              <a
                href="/dashboard/admin/users"
                className="absolute hover:text-gray-400 cursor-pointer top-2 right-2"
          ...
          <div className="bg-white bg-dark py-4 mt-3 border-b-2 border-gray-100">
            <p className="text-xl text-gray-400 font-bold">Total Earn</p>
            {earnData && (
              <div
                id="charts"
              ...
              >
                <ReactApexChart
                  options={earnTable.options}
                  series={earnTable.series}
                  type="donut"
                  width={300}
                />
                <div className="w-[87px] h-[87px]  -ml-[98px] mt-[82px] flex flex-col items-center justify-center font-bold absolute rounded-full bg-white bg-dark ">
                  <p className="-mt-5">
          ...
          <div className="w-full shadow-md mt-10">
            <p className="font-semibold rounded-sm rounded-b-none text-white px-3 pt-2 bg-emerald-500 pb-1">
              Boost history
            </p>
            <a
              href="/dashboard/admin/approval"
              className="flex justify-between cursor-pointer border-b hover:bg-gray-200 duration-150 w-full items-center p-2"
            >
              <p className="font-light flex items-center gap-2">
                <svg
                  class="w-6 h-6 text-emerald-500 hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <p className="font-light ">
                {formatNumber(data?.boostHistoryApproved)}
              </p>
              <svg
            ...
            >
              ...
              <p className="font-light">
                {formatNumber(data?.boostHistoryNotApproved)}
              </p>
          ...
          <div className="w-full shadow-md mt-10">
            <p className="font-semibold rounded-sm rounded-b-none text-white px-3 pt-2 bg-[#00aeff] pb-1">
            ...
            >
              ...
              <p className="font-light ">
                {formatNumber(data?.subscriptionHistoryApproved)}
              </p>
              <svg
                class="w-6 cursor-pointer h-6 "
                aria-hidden="true"
            ...
            >
              ...
              <p className="font-light">
                {formatNumber(data?.subscriptionHistoryNotApproved)}
              </p>
