...
const Company = (props) => {
  ...
  return (
    <div className="w-full pr-10 flex flex-col lg:flex-row gap-5">
      <div className="flex flex-col border-r pr-4 w-full lg:flex-[70%]">
        ...
        <div class="relative  shadow-md sm:rounded-lg">
          ...
          <div className="flex flex-col w-full gap-4 lg:flex-row mt-2">
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        >
                          {/* {e?.saver?.profilePicture ? (
                            ...
                            <div className="w-12 h-12 rounded-full text-4xl flex items-center justify-center border bg-main text-white">
                              {e?.saver?.firstName?.substring(0, 1)}
                            </div>
                          )} */}
                          <ProfilePicture user={e} />
                          {/* <div class="ps-3">
                            <div class="text-base font-semibold">{e?.saver?.firstName} { e?.saver?.lastName}</div>
                            <div class="font-normal text-gray-500">
                              {e?.saver?.phone}
                            </div>
                          </div> */}
            ...
            {/* <Tables data={data?.saves} columns={saveColumn} title="SAVES" />
      ...
      <div className="flex flex-col w-full lg:flex-[30%]">
        <div className="flex gap-1 items-center justify-between p-2 bg-gray-100 dark:bg-gray-600 rounded-sm">
          <div className="flex relative w-[90px] p-2 h-full bg-white bg-dark">
            <div className=" rounded-lg gap-1 flex flex-col items-start justify-start">
              <div className="flex py-1 px-1 text-white bg-emerald-400 rounded-sm">
                <svg
                  class="w-6 h-6 "
              ...
              <p className="text-sm ">1000 Times</p>
            </div>
            <a
          ...
          <div className="flex relative p-2 w-[90px] h-full bg-white bg-dark">
            <div className=" rounded-lg gap-1 flex flex-col items-start justify-start">
              <div className="flex py-1 px-1 text-white bg-yellow-400 rounded-sm">
                <svg
                  class="w-6 h-6 "
          ...
          <div className="flex p-2 w-[90px] relative h-full bg-white bg-dark">
            <div className=" rounded-lg gap-1 flex flex-col items-start justify-start">
              <div className="flex py-1 px-1 text-white bg-main rounded-sm">
                <svg
                  class="w-6 h-6 "
              ...
              <p className="text-sm">99 Times</p>
            </div>
            <a
