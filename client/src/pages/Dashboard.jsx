  ...
  return (
    <div>
                  ...
                  <a href={`/dashboard/views`} className="cursor-pointer">
                    <div className="items-center flex flex-col justify-center">
                      ...
                      >
                        ...
                        {views?.data?.length > 0 && (
                          <div class="absolute text-xs inline-flex items-center p-[2px] justify-center w-auto min-w-6 h-6 font-bold text-white bg-main border-2 border-white rounded-full -top-2 -end-3 dark:border-gray-900">
                            {views?.data?.length}
                          </div>
                        )}
                      </button>
      ...
      <div
        ...
        // class="py-6 mt-20 w-[100%] lg:w-[76%] xl:w-[81%] px-3 md:px-6 lg:px-10 relative bg-red-500 bg-dark bg-whites lg:ml-64"
      >
        {/* <Routes>
